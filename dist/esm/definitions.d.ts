...
export interface GoogleTokenizationRequest {
    /**
     * Sets the Token ReferenceId that should be used for the tokenization attempt (see TokenServiceProvider).
     *
     * @since 1.0.0
     */
...
export declare type GooglePaySuccessEvent = {
    requestCode: number;
    data: Record<string, string>;
};
export declare type GooglePayFailureEvent = {
    errorCode: number;
    message: string;
};
export interface GooglePayPlugin {
     ...
     * @since 1.0.0
     */
    getTokenStatus(options: GooglePayTokenOptions): Promise<{
        state: TokenStatusReference;
        code: string;
    }>;
    /**
     ...
     * @since 1.0.0
     */
    isTokenized(options: GooglePayIsTokenizedOptions): Promise<{
        isTokenized: boolean;
    }>;
    /**
     *  Starts the push tokenization flow
     ...
     * @since 1.0.0
     */
    pushProvision(options: GooglePayProvisionOptions): Promise<{
        tokenId: string;
    }>;
    /**
     ...
     * @since 1.0.0
     */
    requestSelectToken(options: GooglePayTokenOptions): Promise<{
        isSuccess: boolean;
    }>;
    /**
     ...
     * @since 4.0.13
     */
    requestDeleteToken(options: GooglePayTokenOptions): Promise<{
        isSuccess: boolean;
    }>;
    /**
     ...
     * @since 4.0.4
     */
    setGPayAsDefaultNFCApp(): Promise<{
        isDefault: boolean;
    }>;
    /**
     * returns the status of a token with a given token ID
